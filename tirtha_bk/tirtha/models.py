...
class Run(models.Model):
    ...
    status_options = [
        ...
        (
            "Cancelled",
            "Cancelled",
        ),  # Currently, for runs that were intentionally stopped (COLMAP issue etc.) | Later, if the run is cancelled by admin.
    ]
    status = models.CharField(
    ...
    # Notes for cancelled/errored runs (includes reason and log file path)
    ...
    initCamPosX = models.FloatField(
        default=0.0, null=True, verbose_name="Init Camera Pos X"
    )
    initCamPosY = models.FloatField(
        default=0.0, null=True, verbose_name="Init Camera Pos Y"
    )
    initCamPosZ = models.FloatField(
        default=5.0, null=True, verbose_name="Init Camera Pos Z"
    )

    initCamLookAtX = models.FloatField(
        default=0.0, null=True, verbose_name="Init Camera LookAt X"
    )
    initCamLookAtY = models.FloatField(
        default=0.0, null=True, verbose_name="Init Camera LookAt Y"
    )
    initCamLookAtZ = models.FloatField(
        default=0.0, null=True, verbose_name="Init Camera LookAt Z"
    )

    antialiased = models.BooleanField(default=True, verbose_name="Antialiased")
    sphDegree = models.IntegerField(
        default=2, verbose_name="Spherical Harmonics Degree (0/1/2)"
    )
    focalAdjustment = models.FloatField(
        default=10.0, verbose_name="Focal Length Adjustment"
    )
